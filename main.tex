...
\newcommand{\thesisentopic}{A Guide for future VR development at the IPE with the unreal engines}
...
\begin{document}
    ...
    %\chapter{PhantomCLI - Investigating the phantom protocol}
    %\input{./chap/chapter3.tex}
    %\chapter{UCAPhantom - A Libuca plugin}
    %\input{./chap/chapter4.tex}
    
    % Honestly maybe I am not even doing this chapter.
	%\chapter{Commisioning of the camera}
